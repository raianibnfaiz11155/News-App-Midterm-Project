...
public final class FragmentScienceBinding implements ViewBinding {
  ...
  private FragmentScienceBinding(@NonNull SwipeRefreshLayout rootView,
  ...
  @NonNull
  public static FragmentScienceBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentScienceBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_science, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentScienceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentScienceBinding((SwipeRefreshLayout) rootView, rvRecyclerView,
          swipeRefreshLayout);
    }
